...
void _exerciseSerialize(
  ...
  writer.writeBool(offsets[3], object.soundAlert);
...
Exercise _exerciseDeserialize(
  ...
  object.restTime = reader.readLong(offsets[2]);
  object.soundAlert = reader.readBool(offsets[3]);
  object.type =
...
const _ExercisetypeValueEnumMap = {
  r'reps': ExerciseType.reps,
  r'time': ExerciseType.time,
};
...
extension ExerciseQueryFilter
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> soundAlertEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'soundAlert',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> valueEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'value',
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> valueGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> valueLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> valueBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
